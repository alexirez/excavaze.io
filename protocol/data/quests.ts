export interface QuestTemplate {
  ...
  description: string
  target: number
  event: 'kill_square' | 'kill_player' | 'survive_duration' | 'reach_xp' | 'reach_level'
  rewardGems: number
}
...
export const QUEST_TEMPLATES: QuestTemplate[] = [
  ...
  { id: 'survive_40_sec', description: 'Survive 40 seconds in one game', target: 40, event: 'survive_duration', rewardGems: 40 },
  { id: 'survive_90_sec', description: 'Survive 90 seconds in one game', target: 90, event: 'survive_duration', rewardGems: 110 },
  { id: 'reach_level_7', description: 'Reach level 7', target: 7, event: 'reach_level', rewardGems: 240 },
