export interface QuestTemplate {
  ...
  description: string
  target: number
  event: 'kill_square' | 'kill_player' | 'survive_duration' | 'reach_level' | 'reach_xp'
  rewardGems: number
}
...
export const QUEST_TEMPLATES: QuestTemplate[] = [
  ...
  { id: 'reach_level_7', description: 'Reach level 7', target: 7, event: 'reach_level', rewardGems: 180 },
